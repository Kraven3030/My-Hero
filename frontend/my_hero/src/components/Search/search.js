        ...
        <div className="flex justify-center pb-10 pt-10">
            <form className="flex flex-col items-center w-5/6">
                ...
                <div className="mt-4 flex">
                    <div className="ml-2">
                        <input ref={inputHero} type="radio" value="heroes" onChange={handleRadioChange} checked={searchType === "heroes"} className="form-radio text-blue-500 dark:text-blue-500" />
                ...
                <div className="pt-4">
                    <button onClick={handleClick} type="submit" className="p-2.5 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Search
                    </button>
                </div>
            </form>
