...
function Nav(props) {
    ...
    const initialState = [<h1><Link to='/' key="1">My Hero</Link></h1>]
                ...
                initialState.concat(
                    <div>
                        <ul>
                            ...
                            <li key="3">
                                <button className="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2" onClick={handleLogout}>Logout</button>
                            </li>
                        </ul>
                    </div>
                )
        ...
        <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
            <div className="container flex flex-wrap items-center justify-between mx-auto">
                <a href="/" className="flex items-center">
                    <img src="/my-hero-high-resolution-color-logo.png" className="h-6 mr-3 sm:h-12" alt="My Hero Logo" />
