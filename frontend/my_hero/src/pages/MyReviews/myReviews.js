...
function MyReviews({ closeModal, isOpen }) {
    ...
    return (
        <>
            <h1 className="pt-10 pb-5 text-center text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500 uppercase">My personal Reviews</h1>            <div className="place-content-center">
