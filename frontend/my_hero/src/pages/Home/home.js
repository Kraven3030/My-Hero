...
function Home() {
    return (
        <body className="antialiased bg-gray-200 text-gray-900 font-sans p-6 bg-cover bg-auto" style={{ backgroundImage: `url(${"https://s3.envato.com/files/93e7cf98-8183-471b-b5a3-d28a4f53047d/inline_image_preview.jpg"})` }}>
            <div className="flex justify-center pt-40">
                <div className="w-5/6 p-4 text-center bg-white border rounded-lg shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <p className="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Here at My Hero users can search for their favorite Marvel super heroes to gain
                        more knowledge about them or to find what comics they appeared in and leave reviews and tell others what they enjoy the most about that hero or comic.</p>
